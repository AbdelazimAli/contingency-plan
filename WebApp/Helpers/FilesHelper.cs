...
namespace HR_uploader.Helpers
{
 ...
 //           System.Diagnostics.Debug.WriteLine(Directory.Exists(tempPath));
            ...
            foreach (String inputTagName in httpRequest.Files)
            {
                ...
                //System.Diagnostics.Debug.WriteLine(inputTagName);
        ...
        public ViewDataUploadFilesResult UploadResult(String FileName, int fileSize, String FileFullPath,Guid stream_id)
        {
            String getType = System.Web.MimeMapping.GetMimeMapping(FileFullPath);
            var result = new ViewDataUploadFilesResult()
            {
