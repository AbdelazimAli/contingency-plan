...
/// <summary>
/// Summary description for LeavesSchedule
/// </summary>
public class LeavesSchedule : DevExpress.XtraReports.UI.XtraReport,IBasicInfoReport
{
    ...
    public LeavesSchedule()
    {
        InitializeComponent();
        //
        // TODO: Add constructor logic here
        //
        this.Parameters["from"].Value = DateTime.Today;
    }
    ...
    private void InitializeComponent()
    {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(LeavesSchedule));
            ...
            this.xrLabel21.LocationFloat = new DevExpress.Utils.PointFloat(2475.334F, 225.0105F);
            this.xrLabel21.Name = "xrLabel21";
            this.xrLabel21.Padding = new DevExpress.XtraPrinting.PaddingInfo(5, 5, 0, 0, 254F);
            this.xrLabel21.SizeF = new System.Drawing.SizeF(465.6663F, 58.42F);
            this.xrLabel21.StylePriority.UseBackColor = false;
            this.xrLabel21.StylePriority.UseFont = false;
            this.xrLabel21.StylePriority.UseForeColor = false;
            this.xrLabel21.StylePriority.UseTextAlignment = false;
            this.xrLabel21.Text = ":  خريطة أجازات الموظفين من تاريخ";
            ...
            this.xrLabel4.Text = "الجدول الزمني للاجازات";
            ...
            this.xrLabel22.LocationFloat = new DevExpress.Utils.PointFloat(2163.958F, 225.0105F);
            ...
            // from
            // 
            this.from.Description = "تاريخ الاجازات من";
            this.from.Name = "from";
            ...
            this.xrLabel12.Text = "اسم الموظف";
            ...
            // DeptIdss
            // 
            this.DeptIdss.Description = "الإدارة";
            ...
            // EmpIdss
            // 
            this.EmpIdss.Description = "اسم الموظف";
            ...
            this.EmpIdss.LookUpSettings = dynamicListLookUpSettings2;
            ...
            // JobIdss
            // 
            this.JobIdss.Description = "الوظيفة";
            ...
            this.JobIdss.LookUpSettings = dynamicListLookUpSettings3;
            ...
            this.GroupHeader1.HeightF = 65.26389F;
            this.GroupHeader1.Name = "GroupHeader1";
            // 
            // xrLabel5
            // 
            this.xrLabel5.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "SP_LeavesSchedule.deptName")});
            ...
            this.xrLabel5.LocationFloat = new DevExpress.Utils.PointFloat(2475.334F, 0F);
            this.xrLabel5.Name = "xrLabel5";
            this.xrLabel5.Padding = new DevExpress.XtraPrinting.PaddingInfo(5, 5, 0, 0, 254F);
            this.xrLabel5.SizeF = new System.Drawing.SizeF(475.3193F, 58.42F);
    ...
    {
        this.Parameters["DayOne"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(0);
        this.Parameters["DayTwo"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(1);
        this.Parameters["DayThree"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(2);
        this.Parameters["DayFour"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(3);
        this.Parameters["DayFive"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(4);
        this.Parameters["DaySix"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(5);
        this.Parameters["DaySeven"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(6);

        /*
         * if (DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(0).DayOfWeek == DayOfWeek.Friday || DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(0).DayOfWeek == DayOfWeek.Saturday)
        {
            this.Parameters["DayOne"].Value = null;
        }
        else
        {
            this.Parameters["DayOne"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(1);

        }
        if (DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(1).DayOfWeek == DayOfWeek.Friday || DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(1).DayOfWeek == DayOfWeek.Saturday)
        {
            this.Parameters["DayTwo"].Value = null;
        }
        else
        {
            this.Parameters["DayTwo"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(1);
        ...
        if (DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(2).DayOfWeek == DayOfWeek.Friday || DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(2).DayOfWeek == DayOfWeek.Saturday)
        {
            this.Parameters["DayThree"].Value = null;
        }
        else
        {
            this.Parameters["DayThree"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(2);
        ...
        if (DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(3).DayOfWeek == DayOfWeek.Friday || DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(3).DayOfWeek == DayOfWeek.Saturday)
        {
            this.Parameters["DayFour"].Value = null;
        }
        else
        {
            this.Parameters["DayFour"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(3);
        ...
        if (DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(4).DayOfWeek == DayOfWeek.Friday|| DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(4).DayOfWeek == DayOfWeek.Saturday)
        {
            this.Parameters["DayFive"].Value = null;
        }
        else
        {
            this.Parameters["DayFive"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(4);
        ...
        if (DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(5).DayOfWeek == DayOfWeek.Friday || DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(5).DayOfWeek == DayOfWeek.Saturday)
        {
            this.Parameters["DaySix"].Value = null;
        }
        else
        {
            this.Parameters["DaySix"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(5);
        ...
        if (DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(6).DayOfWeek == DayOfWeek.Friday || DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(6).DayOfWeek == DayOfWeek.Saturday)
        {
            this.Parameters["DaySeven"].Value = null;
        }
        else
        {
            this.Parameters["DaySeven"].Value = DateTime.Parse(this.Parameters["from"].Value.ToString()).AddDays(6);
